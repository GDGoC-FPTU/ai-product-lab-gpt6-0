...
def evaluate_prompt(user_input: str) -> str:
    ...
    if not api_key:
        raise RuntimeError(
            ...
            "in the environment or in the local .env file."
        )

    # New Google GenAI SDK (preferred standard).
    ...
    try:
        ...
        # Preserve the original exception as the cause instead of hiding it and
        # returning None, which makes the verification code fail misleadingly.
